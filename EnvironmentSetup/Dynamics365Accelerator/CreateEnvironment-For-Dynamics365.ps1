...
Write-Output ("Get ready... about to create: $TotalNoOfInstances instances.");    
for ($i = [int]$SuffixStart; $i -le $SuffixEnd; $i++) 
{
    Write-Output ("$i : $OrganizationFriendlyName$i");    
}

$ConfirmToProceed = Read-Host -Prompt "Really want to create them... (yes or no)?"    
